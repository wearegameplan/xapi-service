...
var matchProfileIdentifier_1 = __importDefault(require("./utils/matchProfileIdentifier"));
var matchProfileSince = function (profile, since) {
...
exports.default = (function (config) {
    return function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        var client, activityId, matchingProfiles, profileIds;
        return __generator(this, function (_a) {
            ...
            profileIds = matchingProfiles.map(function (profile) {
