...
var checkEtag_1 = __importDefault(require("./utils/checkEtag"));
var checkMaxEtags_1 = __importDefault(require("./utils/checkMaxEtags"));
var createProfile_1 = __importDefault(require("./utils/createProfile"));
var matchUniqueProfile_1 = __importDefault(require("./utils/matchUniqueProfile"));
    ...
    return function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            config.state.activityProfiles = config.state.activityProfiles.map(function (profile) {
                ...
                var isJson = (isMatch &&
                    profile.contentType === constants_1.jsonContentType &&
                ...
                return __assign(__assign({}, profile), { 
                    ...
                    content: __assign(__assign({}, profile.content), opts.content), etag: opts.etag, extension: 'json', 
