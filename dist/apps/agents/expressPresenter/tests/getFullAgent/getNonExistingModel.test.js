...
describe('expressPresenter.getFullAgent with non-existing model', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getFullAgent_1.default(agent).expect(http_status_codes_1.OK, expectedResult)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should throw warnings when using an invalid agent', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getFullAgent_1.default(testValues_1.TEST_INVALID_AGENT).expect(http_status_codes_1.BAD_REQUEST)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
