    ...
    it('should get when getting text', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getProfile_1.default().expect(http_status_codes_1.OK, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // tslint:enable:object-literal-sort-keys
                    _a.sent();
                    return [4 /*yield*/, getProfile_1.default({ agent: retrievalAgent }).expect(http_status_codes_1.OK, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should get when getting json', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getProfile_1.default().expect(http_status_codes_1.OK, JSON.parse(testValues_1.TEST_JSON_CONTENT))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
