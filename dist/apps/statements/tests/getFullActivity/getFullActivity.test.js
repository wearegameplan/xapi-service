        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    assert_1.default.deepEqual(fullActivity, testValues_1.TEST_BASE_ACTIVITY);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should also return the definition when getting a existing activity', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    fullActivity = _a.sent();
                    assert_1.default.deepEqual(fullActivity, testValues_1.TEST_ACTIVITY);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should merge the definitions when storing two definitions in one batch', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    fullActivity = _a.sent();
                    assert_1.default.deepEqual(fullActivity, testValues_1.TEST_MERGED_ACTIVITY);
                    return [2 /*return*/];
            }
        });
    }); });
