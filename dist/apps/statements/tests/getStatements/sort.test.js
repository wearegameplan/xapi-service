...
describe('get statements by sorting', function () {
    ...
    var sortStatements = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storeStatements([createStatement_1.default({ id: TEST_ID_1 })])];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, 1); })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, storeStatements([createStatement_1.default({ id: TEST_ID_2 })])];
                case 3:
                    _a.sent();
                ...
                case 4:
                    ...
                    assert_1.default.equal(sortedStatements.length, 2);
    ...
    it('should return statements in the correct order when ascending', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    statements = _a.sent();
                    assert_1.default.equal(statements[0].id, TEST_ID_1);
                    assert_1.default.equal(statements[1].id, TEST_ID_2);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should return statements in the correct order when ascending', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    statements = _a.sent();
                    assert_1.default.equal(statements[1].id, TEST_ID_1);
                    assert_1.default.equal(statements[0].id, TEST_ID_2);
                    return [2 /*return*/];
            }
        });
    }); });
